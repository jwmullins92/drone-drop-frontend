            ...
            <div className="d-flex flex-column justify-content-start align-items-center">
                <div className="col-12 col-lg-5">
                    ...
                    <ul className="list-group list-group-flush mb-4 primary-border">
                        <li className="list-group-item card-text card-color-md d-flex justify-content-between"><b>Name:</b> <span>{props.user.firstName} {props.user.lastName}</span></li>
                        <li className="list-group-item card-text card-color-md d-flex justify-content-between"><b>Username:</b> <span>{props.user.username}</span></li>
                        <li className="list-group-item card-text card-color-md d-flex justify-content-between text-end"><b>Address:</b> <span>{props.user.address}</span></li>
                    </ul>
                </div>
